  ...
  <div>
    ...
    >
      ...
      <div style="margin-top: 20px">
        ...
        <el-button type="primary" @click="submitForm()" :disabled="isDisabled" style="width: 150px"><i class="el-icon-circle-plus el-icon--left"></i>批量添加</el-button>
      </div>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.axios({
        method: "post",
        url: "https://api-vnt.fdkevin.xyz/checkIsGraduate",
        headers: { Authorization: keystore, code: code },
      ...
      .then(function (response) {
          ...
          that.isDisabled = false;
          that.loading = false;
          that.$confirm("此次交易号: " + response.data.txHash + "</a>","添加学生毕业成功!",
        {
          confirmButtonText: "确定",
